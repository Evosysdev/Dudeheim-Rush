...
public class DudeheimAccessor implements TweenAccessor<Dudeheim>
{
    ...
    @Override
    public int getValues(Dudeheim target, int tweenType, float[] returnValues) {
        switch (tweenType) {
    ...
    @Override
    public void setValues(Dudeheim target, int tweenType, float[] newValues) {
        switch (tweenType) {
